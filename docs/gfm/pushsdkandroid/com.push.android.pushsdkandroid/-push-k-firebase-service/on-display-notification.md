...
Called when notification will be displayed, this method displays a notification. Displaying a notification is not guaranteed if the application's notification limit has been reached. The method will not be called if onReceiveDataPush wasn't called before
